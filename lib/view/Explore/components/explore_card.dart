    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: CachedNetworkImage(
          imageUrl: getFullImageUrl(widget.category.image),
          imageBuilder: (context, imageProvider) => Material(
            ...
            child: AnimatedContainer(
              ...
              height: _selected
                  ? (MediaQuery.of(context).size.height * 0.25).clamp(180, 250)
                  : (MediaQuery.of(context).size.height * 0.18).clamp(120, 160),
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        devicesController.getProductByCategory(
