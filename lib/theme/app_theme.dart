...
class AppTheme {
  ...
  static final lightTheme = ThemeData(
      ...
      textButtonTheme: TextButtonThemeData(
          style: TextButton.styleFrom(foregroundColor: lightBackgroundColor)), colorScheme: ColorScheme.light(secondary: lightSecondaryColor).copyWith(surface: lightBackgroundColor)
  );
